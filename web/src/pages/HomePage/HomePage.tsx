  ...
  return (
    <>
      ...
      <section className="flex flex-col justify-center min-h-screen max-h-screen">
        <h1 className="w-24 text-center p-1 rounded-md rounded-tr-full rounded-bl-lg text-sm bg-primary">
          Hello, 👋
        </h1>
        ...
        <nav className="fixed text-gray-400 text-2xl bottom-[5%] md:bottom-[15%] right-[10%] flex flex-col items-center gap-6">
